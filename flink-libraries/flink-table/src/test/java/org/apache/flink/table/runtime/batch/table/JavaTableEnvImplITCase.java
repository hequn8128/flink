...
public class JavaTableEnvImplITCase extends TableProgramsCollectionTestBase {

	public JavaTableEnvImplITCase(TableConfigMode configMode) {
		super(configMode);
	}
	...
	public void testSimpleRegister() throws Exception {
		...
		BatchTableEnvironment tableEnv = TableEnvImpl.getTableEnvironment(env, config());
	...
	public void testRegisterTableFromOtherEnv() throws Exception {
		ExecutionEnvironment env = ExecutionEnvironment.getExecutionEnvironment();
		BatchTableEnvironment tableEnv1 = TableEnvImpl.getTableEnvironment(env, config());
		BatchTableEnvironment tableEnv2 = TableEnvImpl.getTableEnvironment(env, config());
