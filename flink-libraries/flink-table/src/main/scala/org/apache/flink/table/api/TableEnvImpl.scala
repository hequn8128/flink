...
import org.apache.flink.table.api.java.{BatchTableEnvironment => JavaBatchTablePlanner, StreamTableEnvironment => JavaStreamTablePlanner}
import org.apache.flink.table.api.scala.{BatchTableEnvironment => ScalaBatchTablePlanner, StreamTableEnvironment => ScalaStreamTablePlanner}
...
/**
  ...
  */
abstract class TableEnvImpl(val config: TableConfig) {
...
object TableEnvImpl {
  ...
  /**
    * Returns a [[BatchTableEnvImpl]] for a Java [[JavaBatchExecEnv]].
    *
  ...
  /**
    * Returns a [[BatchTableEnvImpl]] for a Java [[JavaBatchExecEnv]] and a given [[TableConfig]].
    *
    * @param executionEnvironment The Java batch ExecutionEnvironment.
  ...
  /**
    * Returns a [[BatchTableEnvImpl]] for a Scala [[ScalaBatchExecEnv]].
    *
  ...
  /**
    * Returns a [[BatchTableEnvImpl]] for a Scala [[ScalaBatchExecEnv]] and a given
    * [[TableConfig]].
    *
    * @param executionEnvironment The Scala batch ExecutionEnvironment.
    * @param tableConfig The TableConfig for the new TableEnvironment.
  ...
  /**
    * Returns a [[StreamTableEnvImpl]] for a Java [[JavaStreamExecEnv]].
    *
  ...
  /**
    * Returns a [[StreamTableEnvImpl]] for a Java [[JavaStreamExecEnv]] and a given [[TableConfig]].
    *
    * @param executionEnvironment The Java StreamExecutionEnvironment.
    * @param tableConfig The TableConfig for the new TableEnvironment.
    */
  ...
  /**
    * Returns a [[StreamTableEnvImpl]] for a Scala stream [[ScalaStreamExecEnv]].
    *
