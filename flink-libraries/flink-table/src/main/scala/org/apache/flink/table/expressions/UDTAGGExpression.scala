...
/**
  * A class which creates a call to a table aggregateFunction
  */
case class UDTAGGExpression[T: TypeInformation, ACC: TypeInformation](
  tableAggregateFunction: TableAggregateFunction[T, ACC]) {

  /**
    * Creates a call to an [[TableAggregateFunction]].
    *
