...
/**
  * A base code generator for generating [[GeneratedAggregations]] or
...
class AggregationBaseCodeGenerator(
  ...
  protected val reusableCleanupStatements = mutable.LinkedHashSet[String]()
  ...
  var distinctAggs: Array[Seq[DataViewSpec[_]]] = _
  ...
  def init(): Unit = {
    ...
    distinctAggs = isDistinctAggs.zipWithIndex.map {
