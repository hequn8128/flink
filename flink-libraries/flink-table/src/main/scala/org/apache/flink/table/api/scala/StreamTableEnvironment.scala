...
class StreamTableEnvironment(
  ...
  /**
    ...
    * @return The converted [[Table]].
    */
  def fromUpsertStream[T: TypeInformation](dataStream: DataStream[JTuple2[JBool, T]]): Table = {
  ...
  /**
    ...
    *   val tab: Table = tableEnv.fromUpsertStream(stream, 'a, 'b)
    * }}}
    *
    * @param dataStream The [[DataStream]] to be converted.
    * @param fields The field names of the resulting [[Table]].
    ...
    * @return The converted [[Table]].
    */
  def fromUpsertStream[T: TypeInformation](
  ...
  /**
    ...
    * @tparam T The type of the [[DataStream]] to register.
    */
  def registerAppendStream[T](name: String, dataStream: DataStream[T], fields: Expression*): Unit = {
