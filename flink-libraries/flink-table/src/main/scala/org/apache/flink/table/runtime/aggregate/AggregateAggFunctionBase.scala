...
/**
  * Base Aggregate Function used for the aggregate operator in
  * [[org.apache.flink.streaming.api.datastream.WindowedStream]]
  *
  * @param genAggregations Generated aggregate helper function
  */
abstract class AggregateAggFunctionBase[OUT, F <: AggregationsFunction](
    genAggregations: GeneratedAggregationsFunction)
  extends AggregateFunction[CRow, Row, OUT] with Compiler[F] with Logging {

  protected var function: F = _
