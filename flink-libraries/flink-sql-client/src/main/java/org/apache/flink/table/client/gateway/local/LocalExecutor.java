...
public class LocalExecutor implements Executor {
	...
	public List<String> listTables(SessionContext session) throws SqlExecutionException {
		final TablePlanner tableEnv = getOrCreateExecutionContext(session)
	...
	public String explainStatement(SessionContext session, String statement) throws SqlExecutionException {
		...
		final TablePlanner tableEnv = context
			.createEnvironmentInstance()
			.getTableEnvironment();
	 ...
	 */
	private Table createTable(TablePlanner tableEnv, String selectQuery) {
	 ...
	 */
	private <C> void applyUpdate(ExecutionContext<C> context, TablePlanner tableEnv, QueryConfig queryConfig, String updateStatement) {
