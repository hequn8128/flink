...
public class TableConfig {
	 ...
	 */
	public Configuration getUserDefinedConfig() {
	 ...
	 */
	public void setUserDefinedConfig(Configuration userDefinedConfig) {
		this.userDefinedConfig = GlobalConfiguration.loadConfiguration();
		this.userDefinedConfig.addAll(userDefinedConfig);
	}
}
