...
/**
 * Base class for Group Window.
 *
 * <p>GroupWindow groups rows based on time or row-count intervals. It is a general way to group the
 ...
 *
 * <p>For finite batch tables, window provides shortcuts for time-based groupBy.
 *
 */
@PublicEvolving
