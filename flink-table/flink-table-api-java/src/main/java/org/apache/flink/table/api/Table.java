...
public interface Table {
	...
	/**
	 * Creates {@code TemporalTableFunction} backed up by this table as a history table.
	 * Temporal Tables represent a concept of a table that changes over time and for which
	 * Flink keeps track of those changes. {@code TemporalTableFunction} provides a way how to
	 * access those data.
	 *
	 * <p>For more information please check Flink's documentation on Temporal Tables.
	 *
	 * <p>Currently {@code TemporalTableFunction}s are only supported in streaming.
	 *
	 ...
	 * @return {@code TemporalTableFunction} which is an instance of {@link TableFunction}.
	 *        It takes one single argument, the {@code timeAttribute}, for which it returns
	 *        matching version of the {@link Table}, from which {@code TemporalTableFunction}
	 *        was created.
	 */
	TableFunction<Row> createTemporalTableFunction(String timeAttribute, String primaryKey);
	 ...
	 *        was created.
	 */
	TableFunction<Row> createTemporalTableFunction(Expression timeAttribute, Expression primaryKey);
