...
public class Rowtime implements Descriptor {
	...
	public Rowtime watermarksFromStrategy(WatermarkStrategy strategy) {
		internalProperties.putString(ROWTIME_WATERMARKS_TYPE, ROWTIME_WATERMARKS_TYPE_VALUE_CUSTOM);
		internalProperties.putString(ROWTIME_WATERMARKS_CLASS, strategy.getClass().getName());
		internalProperties.putString(ROWTIME_WATERMARKS_SERIALIZED, EncodingUtils.encodeObjectToString(strategy));
		return this;
	}
