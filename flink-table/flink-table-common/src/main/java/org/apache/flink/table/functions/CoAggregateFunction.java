...
/**
 * Base class for co-user-defined aggregates.
 *
 * <p>The behavior of an {@link CoAggregateFunction} can be defined by implementing a series of custom
 * methods. An {@link CoAggregateFunction} needs at least four methods:
 * <ul>
 ...
 * the {@link CoAggregateFunction} while other methods are explained below.
 *
 * <pre>
 * {@code
 ...
 */
@PublicEvolving
public abstract class CoAggregateFunction<T, ACC> extends UserDefinedAggregateFunction<T, ACC> {

	// same with AggregateFunction
}
