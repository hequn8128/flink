...
public class Schema implements Descriptor {
	...
	/**
	 * These constants will be removed once SchemaValidator is ported to flink-table-common.
	 */
	...
	private Map<String, LinkedHashMap<String, String>> tableSchema = new LinkedHashMap<>();
