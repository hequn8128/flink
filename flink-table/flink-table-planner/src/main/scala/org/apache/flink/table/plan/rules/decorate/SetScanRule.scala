...
import org.apache.flink.table.plan.nodes.datastream.{DataStreamScan, InputOutputUpdateModeTrait, InputOutputUpdateModeTraitDef, UpdateMode}

// todo: take other sources into consideration.
class SetScanRule extends RelOptRule(
  operand(
    classOf[DataStreamScan], none()),
  "SetScanRule") {
