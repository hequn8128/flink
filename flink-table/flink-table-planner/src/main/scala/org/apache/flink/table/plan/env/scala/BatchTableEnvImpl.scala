 ...
 */
package org.apache.flink.table.plan.env.scala
...
/**
  * The [[TableEnvImpl]] for a Scala batch [[ExecutionEnvironment]] that works
  * with [[DataSet]]s.
  *
  ...
  */
class BatchTableEnvImpl @deprecated(
      "This constructor will be removed. Use BatchTableEnvironment.create() instead.",
      "1.8.0") (
    execEnv: ExecutionEnvironment,
    config: TableConfig)
  extends org.apache.flink.table.plan.env.BatchTableEnvImpl(
    execEnv.getJavaEnv,
...
//    new BatchTableEnvImpl(executionEnvironment, new TableConfig())
//  }
//
//  /**
//    * The [[TableEnvImpl]] for a Scala batch [[ExecutionEnvironment]] that works
...
//
//    new BatchTableEnvImpl(executionEnvironment, tableConfig)
//  }
//}
