...
_TYPEINFO_TYPENAME = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CHAR', index=10, number=10,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BIG_INT', index=11, number=11,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BIG_DEC', index=12, number=12,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SQL_DATE', index=13, number=13,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SQL_TIME', index=14, number=14,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='SQL_TIMESTAMP', index=15, number=15,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOCAL_DATE', index=16, number=16,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOCAL_TIME', index=17, number=17,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='LOCAL_DATE_TIME', index=18, number=18,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='INSTANT', index=19, number=19,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ARRAY', index=20, number=20,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PICKLED_BYTES', index=21, number=21,
      options=None,
      type=None),
  ],
  containing_type=None,
