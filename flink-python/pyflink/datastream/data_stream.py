...
from pyflink.common.typeinfo import TypeInformation, RowTypeInfo, PickledBytesTypeInfo
from pyflink.datastream.udfs import _get_python_env, FlatMapFunctionWrapper, FlatMapFunction, \
    MapFunction, MapFunctionWrapper
...
class DataStream(object):
    ...
    def _get_java_python_function_operator(self, func, type_info, func_name, func_type):
        ...
        :return: A flink java operator which is responsible for execution user defined python function.
        """
